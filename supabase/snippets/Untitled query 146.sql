...
--   2. Change 'doronvoro@gmail.com' on the v_email line below (inside the DO
...
DO $$
DECLARE
  v_email   text := 'doronvoro@gmail.com';   -- ◀── EDIT THIS
  v_user_id uuid;
  v_role_id uuid;
  v_existing int;
BEGIN
...
-- from auth.users u
-- where lower(u.email) = lower('doronvoro@gmail.com');
--
...
--    and r.name = 'admin' and lower(u.email) = lower('doronvoro@gmail.com');
