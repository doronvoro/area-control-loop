...
function SheetContent({
  ...
  /**
   * Classes for the backdrop. A sheet opened on top of another sheet passes a
   * lighter tint here — two default `bg-black/50` scrims composite to 75%
   * black, which buries whatever is underneath.
   */
